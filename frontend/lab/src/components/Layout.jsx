...
import { LayoutDashboard, FlaskConical, ClipboardList, LogOut, Beaker, ClipboardPen, CreditCard, BarChart2, Users, Menu, X } from 'lucide-react'
    ...
    <div className="flex h-screen overflow-hidden bg-gray-50">
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="md:hidden flex items-center gap-3 px-4 py-3 border-b border-gray-200 bg-white sticky top-0 z-30">
          ...
          <span className="font-bold text-sm" style={{ color: '#0F2557' }}>BHaratCliniq Laboratory</span>
        </div>
