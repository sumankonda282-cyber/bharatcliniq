      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-2 leading-relaxed">
            ...
            Set a personal password to access CareChart.
          </p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm pr-10 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500"
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full border rounded-xl px-3 py-2.5 text-sm pr-10 focus:outline-none focus:ring-1 transition-colors ${
                    confirm.length > 0 ? (matches ? 'border-emerald-400 focus:ring-emerald-500' : 'border-red-300 focus:ring-red-400') : 'border-gray-200 focus:ring-emerald-500 focus:border-emerald-500'
                  }`}
