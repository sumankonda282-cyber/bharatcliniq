const DB_NAME = 'bh_receptionist_cache'
const DB_VERSION = 1
const STORE = 'cache'

export const TTL = {
  QUEUE:  2 * 60 * 1000,        // 2 min   — dashboard queue snapshot
  SHORT:  10 * 60 * 1000,       // 10 min  — patients, billing
  MEDIUM: 60 * 60 * 1000,       // 1 hour  — doctors list, staff list
...
// one-shot — return cached if fresh, else fetch
