        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li><a href={CARECHART_URL} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Provider Login (CareChart)</a></li>
              <li><a href={PHARMACY_URL} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Pharmacy Module</a></li>
              <li><a href={LAB_URL} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Diagnostics Lab</a></li>
              <li><a href={IMAGING_URL} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Imaging Center</a></li>
            </ul>
          </div>
          <div>
