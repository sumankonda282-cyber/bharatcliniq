      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-2 leading-relaxed">
            ...
            Set a personal password to access BH Pharmacy.
          </p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm pr-10 focus:outline-none focus:border-green-700 focus:ring-1 focus:ring-green-700"
              ...
              {RULES.map(r => {
                ...
                return (
                  <div key={r.key} className={`flex items-center gap-1.5 text-xs px-2.5 py-1.5 rounded-lg transition-colors ${
                    ...
                    : ok ? 'bg-emerald-50 text-green-800' : 'bg-red-50 text-red-500'
                  }`}>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full border rounded-xl px-3 py-2.5 text-sm pr-10 focus:outline-none focus:ring-1 transition-colors ${
                    confirm.length > 0 ? (matches ? 'border-green-600 focus:ring-green-600' : 'border-red-300 focus:ring-red-400') : 'border-gray-200 focus:ring-green-700 focus:border-green-700'
                  }`}
