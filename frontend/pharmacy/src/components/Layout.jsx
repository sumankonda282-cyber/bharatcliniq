...
import { LayoutDashboard, Pill, Package, LogOut } from 'lucide-react'
    ...
    <div className="flex h-screen overflow-hidden bg-gray-50">
      <aside className="w-56 flex flex-col flex-shrink-0" style={{ background: '#0F2557' }}>
        <div className="px-5 py-5 border-b border-white/10">
          ...
          <div className="text-xs font-semibold mt-0.5 tracking-wider uppercase" style={{ color: '#F5821E' }}>Pharmacy</div>
        </div>
