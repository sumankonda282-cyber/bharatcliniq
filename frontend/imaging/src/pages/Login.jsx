...
const FEATURES = [
  { icon: ScanLine,   text: 'View all radiology and imaging orders' },
  { icon: FileImage,  text: 'Update status and add clinical findings' },
  { icon: CheckCircle, text: 'Mark scans complete and deliver reports digitally' },
]
      ...
      >
        ...
        <div>
          <h2 className="text-4xl font-extrabold leading-tight mb-4">
            Imaging Reports,<br />
            <span style={{ color: '#F5821E' }}>Digitally Delivered.</span>
          </h2>
          <p className="text-blue-200 text-lg mb-8">
            Manage radiology and imaging workflows — from order receipt to final report delivery.
          </p>
