  ...
  return (
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-10 text-white" style={{ background: 'linear-gradient(145deg,#0F2557 0%,#1a3a7a 100%)' }}>
        <div><div className="text-2xl font-extrabold">BHaratCliniq</div><div className="text-xs font-semibold mt-1 tracking-wider uppercase" style={{ color: '#F5821E' }}>Imaging Portal</div></div>
        <div>
          <h2 className="text-4xl font-extrabold mb-4">Imaging Reports,<br /><span style={{ color: '#F5821E' }}>Digitally Delivered.</span></h2>
          <p className="text-blue-200 mb-8">Manage radiology and imaging orders, update status, and deliver findings.</p>
          {[{icon:ScanLine,text:'View all imaging & radiology orders'},{icon:FileImage,text:'Update order status and add findings'},{icon:CheckCircle,text:'Mark orders complete digitally'}].map(({icon:Icon,text})=>(
